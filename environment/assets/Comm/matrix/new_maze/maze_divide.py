...
area_maze.to_csv(
    "environment\\assets\Comm\matrix\\new_maze\\maze\\area_maze_2d.csv",
    index=False,
    header=False,
    encoding="utf-8",
)
object_maze.to_csv(
    "environment\\assets\Comm\matrix\\new_maze\\maze\\object_maze_2d.csv",
    index=False,
    header=False,
    encoding="utf-8",
)
collision_maze.to_csv(
    "environment\\assets\Comm\matrix\\new_maze\\maze\\collision_maze_2d.csv",
    index=False,
    header=False,
    encoding="utf-8",
)
